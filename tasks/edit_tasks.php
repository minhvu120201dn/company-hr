...
if ($conn->connect_error) {
    ...
    <form method="post" action="./edit_task_processing.php?id=<?php echo $id ?>" >
        ...
        <dt style="margin-top: 6px;" >Project Id</dt><dd><input type="text" name="proid1" class="form-control" id="recipient-name1" minlength="8" maxlength="250" value="<?php echo $a['project_id'] ?>"></dd>
          <dt style="margin-top: 6px;">Name</dt><dd><input type="text" name="protitle" class="form-control" id="recipient-name1" minlength="8" maxlength="250" value="<?php echo $a['task_title'] ?>" ></dd>
          ...
          <dt style="margin-top: 6px;">Details</dt><dd><textarea class="form-control" name="details" id="message-text1" maxlength="1300"  style="resize: none;"><?php echo $a['task_details'] ? $a['task_details'] : 'Null' ?></textarea></dd>
